...
export const LivroProvider = ({ children }) => {
	...
	const [detalhesDoLivro, setDetalhesDoLivro] = useState(null);  // Detalhes do livro selecionado

	return (
		<LivroContext.Provider value={{ livros, setLivros, detalhesDoLivro, setDetalhesDoLivro }}>
			{children}
